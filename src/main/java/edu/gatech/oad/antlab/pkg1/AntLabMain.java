 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Giorgi Tkeshelashvili");
		  toPrint += p1.toString("giorgi6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Nayomi Mitchell");
		  toPrint += p2.toString("nmitchell7");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Matt Townsend");
		  toPrint += p3.toString("mtownsend9");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Nathan Lowell");
                  toPrint += p4.toString("nlowell3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Stephanie Su");
                  toPrint += p5.toString("ssu36");
